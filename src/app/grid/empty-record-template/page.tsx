    ...
    return (
        <div className='control-pane'>
            <div className='control-section'>
                <GridComponent dataSource={data} emptyRecordTemplate={template} toolbar={toolbarOptions} allowPaging={true} editSettings={editSettings}  pageSettings={pageSettings}>
                <ColumnsDirective>
            ...
            <div id='description'>
                <p>The DataGrid provides a way to use a custom content when it has no data to present.
                    The <code>emptyRecordTemplate</code> property accepts either a string or an HTML element ID value, which will be used as the template when there is no data.</p>
                <p>
