            ...
            <div className='control-section'>
                <div style={{ paddingBottom: '20px' }}>
                    <div style={{ display: 'inline-block', paddingRight: '10px' }}>
                        ...
                        <div style={{ display: 'inline-block', paddingRight: '10px' }}>
                            <DropDownListComponent dataSource={indicatortypes} value="Shimmer" change={indicatorChange} fields={fields} ref={(indicateDropDown) => { indicatorDropDown = indicateDropDown; }} />
                        </div>
                    </div>
                </div>
                <GridComponent id="Grid" dataSource={data} ref={grid => gridInstance = grid as GridComponent} allowPaging={true} pageSettings={{ pageCount: 3 }} loadingIndicator={{ indicatorType: 'Shimmer' }} allowFiltering={true} allowSorting={true}>
                    <ColumnsDirective>
